...
# # # #     while True:
# # # #         try:
# # # #             print(f"Enter the {length} numbers separated by spaces:")
...
# # def display_score_table(score):
# #     """Display the current score in a table format."""
# #     clear_screen()
# #     print("****************************************")
# #     print("       Number Memory Game Scores      ")
# #     print("****************************************")
# #     print(f"\nCurrent Score: {score}")
# #     print()
