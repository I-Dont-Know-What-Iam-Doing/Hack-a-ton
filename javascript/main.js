...
function updateContent(language) {
    ...
    // Update placeholders and button text
    document.getElementById('message-input').placeholder = texts.messagePlaceholder;
    document.querySelector('button[type="submit"]').textContent = texts.sendButton; // Correct button selection

    // Update alerts
    const alertsDiv = document.getElementById('alerts');
    alertsDiv.innerHTML = ''; // Clear existing alerts
    addEmergencyAlert(texts.dangerAlert); // Use correct function for adding alerts
